let taxiFareApiUrl = "https://taxifare.lewagon.com/predict"; // replace with your API endpoint
...
const dropoffAutocomplete = () => {
  ...
  geocoder.on("result", (event) => {
    ...
    const start = [
      parseFloat(document.querySelector("#pickup_longitude").value),
      parseFloat(document.querySelector("#pickup_latitude").value),
    ];
    ...
    form.addEventListener("submit", (e) => {
      ...
      const data = {
        ...
        pickup_longitude:
          ...
          -73.989,
        dropoff_latitude:
          parseFloat(document.getElementById("dropoff_latitude").value) ||
          40.802,
        dropoff_longitude:
          parseFloat(document.getElementById("dropoff_longitude").value) ||
          -73.956,
        passenger_count:
          parseInt(document.getElementById("passenger_count").value) || 2,
